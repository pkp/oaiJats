...
class OAIMetadataFormat_JATS extends OAIMetadataFormat
{
    ...
    protected function findJats(OAIRecord $record): ?DOMDocument
    {
        ...
        // If we have an uploaded file, merge body/back content into the template
        if ($uploadedDoc) {
     ...
     * generated by the JatsTemplate plugin. It does NOT regenerate content that
    ...
    protected function _mungeMetadata(
        ...
        $articleNode->setAttribute('xmlns', 'https://jats.nlm.nih.gov/publishing/1.2/');
    ...
    protected function isCandidateFile(SubmissionFile $submissionFile): bool
    {
        ...
        $genre = $genres[$genreId]; /** @var Genre $genre */
